 ...
 * [hto.yml](hto.yml)
     * Determines how your purl.obolibrary.org/obo/hto/ redirects will be handled
     ...
     * Paste in the contents of [hto.yml](hto.yml)
 ...
 * [hto.md](hto.md)
     ...
     * Paste in the contents of [hto.md](hto.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
